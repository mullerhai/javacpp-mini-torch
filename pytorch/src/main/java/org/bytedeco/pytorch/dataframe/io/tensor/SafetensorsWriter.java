    ...
    private static void writeTensorData(RandomAccessFile raf, DataFrame df, int colIdx, 
        ...
        for (int r = 0; r < df.rowCount(); r++) {
            ...
            if (val == null) {
                ...
                switch (dtype) {
                    case FLOAT16:
                        buf.putShort((short) Float.floatToRawIntBits((float) ((Number) val).doubleValue()));
                        break;
                    case FLOAT32:
                    ...
                    case FLOAT64:
                        ...
                        break;
                    case INT8:
                        buf.put(val == null ? 0 : ((Number) val).byteValue());
                        break;
                    case INT16:
                    ...
                    case INT64:
                        ...
                        break;
                    default:
                        // BOOLEAN and other narrow types -> writeFloat best-effort
                        try {
    ...
    private static void writeZeros(RandomAccessFile raf, Column.DType dtype) throws IOException {
        ...
        switch (dtype) {
            ...
            case BOOLEAN:
                ...
                break;
            default:
                // Unknown types: write 4 bytes of zeros
                size = 4;
        }
