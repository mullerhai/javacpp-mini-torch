 ...
 */
public final class HiveCatalog implements DataCatalog {
    ...
    private HiveCatalog(String metastoreUri, String warehouseUri) {
    ...
    public String metastoreUri() { return metastoreUri; }
    public String warehouseUri() { return warehouseUri; }
    ...
    public static final class Builder {
        ...
        private String warehouseUri = "/user/hive/warehouse";

        public Builder metastoreUri(String uri) { this.metastoreUri = uri; return this; }
        public Builder uri(String uri) { this.metastoreUri = uri; return this; }
        public Builder warehouseUri(String uri) { this.warehouseUri = uri; return this; }
        public HiveCatalog build() { return new HiveCatalog(metastoreUri, warehouseUri); }
    }
}
