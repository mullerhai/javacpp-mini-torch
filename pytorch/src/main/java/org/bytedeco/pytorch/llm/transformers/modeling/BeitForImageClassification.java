...
/**
 * BEiT (BERT Pre-Training of Image Transformers) for image classification.
 */
@Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class BeitForImageClassification extends Module {
    ...
    public BeitForImageClassification(PretrainedConfig config) {
        super("BeitForImageClassification");
    ...
    public static BeitForImageClassification fromConfig(PretrainedConfig config) {
        return new BeitForImageClassification(config);
    }
    ...
    public Tensor forward(Tensor pixelValues) {
        throw new UnsupportedOperationException("BEiT image classification forward not yet implemented");
    }
