...
/**
 * HuggingFace <code>qwen2_5_vlConfig</code>.
 * Reference: transformers/models/qwen2_5_vl/configuration_qwen2_5_vl.py
 */
public final class Qwen2_5VLConfig extends Config {

    public static final String MODEL_TYPE = "qwen2_5_vl";
    ...
    public Qwen2_5VLConfig(PretrainedConfig base) {
        super(base);
        this.depth = toInt(base.extra().get("depth"), 32);
        this.hiddenAct = String.valueOf(base.extra().get("hidden_act"));
        this.intermediateSize = toInt(base.extra().get("intermediate_size"), 3420);
        ...
        this.tokensPerSecond = toInt(base.extra().get("tokens_per_second"), 4);
        this.windowSize = toInt(base.extra().get("window_size"), 112);
    ...
    public int depth() { return toInt(base().extra().get("depth"), 32); }
    public String hiddenAct() { Object v = base().extra().get("hidden_act"); return v == null ? "silu" : String.valueOf(v); }
    public int intermediateSize() { return toInt(base().extra().get("intermediate_size"), 3420); }
    ...
    public int tokensPerSecond() { return toInt(base().extra().get("tokens_per_second"), 4); }
    public int windowSize() { return toInt(base().extra().get("window_size"), 112); }
    ...
    @Override public Class<? extends Config> getClass_() { return Qwen2_5VLConfig.class; }
