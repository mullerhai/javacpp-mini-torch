...
/**
 * HuggingFace <code>grokConfig</code>.
 */
public final class GrokConfig extends Config {

    public static final String MODEL_TYPE = "grok";

    private final double attentionDropout;
    private final int slidingWindow;

    public GrokConfig(PretrainedConfig base) {
        super(base);
    ...
    @Override public Class<? extends Config> getClass_() { return GrokConfig.class; }
