...
/**
 * Output for instance segmentation models (e.g. Mask-RCNN).
 * Mimics HuggingFace: transformers.modeling_outputs.InstanceSegmenterOutput
 */
public class InstanceSegmenterOutput extends org.bytedeco.pytorch.llm.transformers.modeling.output.ModelOutput {
    ...
    public InstanceSegmenterOutput(org.bytedeco.pytorch.Tensor logits,
                                  org.bytedeco.pytorch.Tensor pred_boxes,
                                  org.bytedeco.pytorch.Tensor pred_classes,
                                  org.bytedeco.pytorch.Tensor pred_masks) {
        this(null, logits, pred_boxes, pred_classes, pred_masks);
    }

    public InstanceSegmenterOutput(org.bytedeco.pytorch.Tensor loss,
