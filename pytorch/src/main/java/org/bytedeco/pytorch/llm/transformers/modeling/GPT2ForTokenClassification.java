...
/**
 * GPT-2 model with a token classification head (NER / POS tagging).
 */
@Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class GPT2ForTokenClassification extends Module {
    ...
    public GPT2ForTokenClassification(PretrainedConfig config) {
        super("GPT2ForTokenClassification");
    ...
    public static GPT2ForTokenClassification fromConfig(PretrainedConfig config) {
        return new GPT2ForTokenClassification(config);
    }
    ...
    public Tensor forward(Tensor inputIds) {
        throw new UnsupportedOperationException("GPT-2 token classification forward not yet implemented");
    }
