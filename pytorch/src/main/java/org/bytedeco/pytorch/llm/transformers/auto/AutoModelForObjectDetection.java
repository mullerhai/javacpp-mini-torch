...
import org.bytedeco.pytorch.llm.transformers.modeling.DetrForObjectDetection;
...
/**
 * HF {@code AutoModelForObjectDetection.from_pretrained} entry point.
 *
 * <p>Routes by {@code architectures} / {@code model_type} to DETR family
 * backbones: DETR, ConditionalDETR, DeformableDETR, DETA, DINO, YOLOS,
 * RTDetr, GroundingDINO, Owlv2, TableTransformer.
 *
 * <p>Returns a {@link Bundle} wrapping the loaded Module + tokenizer + ImageProcessor.
 */
public final class AutoModelForObjectDetection {

    private AutoModelForObjectDetection() {}
    ...
    public static Bundle fromDirectory(Path dir) throws IOException {
        ...
        String mt = cfg.modelType() == null ? "detr" : cfg.modelType().name().toLowerCase();
        ...
        Module model = DetrForObjectDetection.fromConfig(cfg);
