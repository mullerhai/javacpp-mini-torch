...
/**
 * HuggingFace <code>llava_nextConfig</code>.
 * Reference: transformers/models/llava_next/configuration_llava_next.py
 */
public final class LlavaNextConfig extends Config {

    public static final String MODEL_TYPE = "llava_next";
    ...
    private final String imageGridPinpoints;
    private final int imageSeqLength;

    public LlavaNextConfig(PretrainedConfig base) {
        super(base);
        ...
        this.imageGridPinpoints = String.valueOf(base.extra().get("image_grid_pinpoints"));
    ...
    public String imageGridPinpoints() { Object v = base().extra().get("image_grid_pinpoints"); return v == null ? null : String.valueOf(v); }
    ...
    @Override public Class<? extends Config> getClass_() { return LlavaNextConfig.class; }
