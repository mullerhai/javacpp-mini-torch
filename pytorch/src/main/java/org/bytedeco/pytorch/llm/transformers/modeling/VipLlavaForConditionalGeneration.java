...
/**
 * VIP-LLaVA model for conditional generation with visual perception.
 * Reference: transformers/models/vip_llava/modeling_vip_llava.py
 */
public final class VipLlavaForConditionalGeneration {
    private VipLlavaForConditionalGeneration() {}
