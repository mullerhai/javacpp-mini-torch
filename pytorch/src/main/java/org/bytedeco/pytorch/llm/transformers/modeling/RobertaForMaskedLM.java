...
public class RobertaForMaskedLM extends Module {
    ...
    public RobertaForMaskedLM(PretrainedConfig config) {
        super("RobertaForMaskedLM");
    ...
    public static RobertaForMaskedLM fromConfig(PretrainedConfig config) {
        return new RobertaForMaskedLM(config);
    }
    ...
    public Tensor forward(Tensor inputIds) {
        throw new UnsupportedOperationException("RoBERTa masked LM forward not yet implemented");
    }
