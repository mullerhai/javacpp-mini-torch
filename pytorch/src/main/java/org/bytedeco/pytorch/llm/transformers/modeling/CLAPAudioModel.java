...
/**
 * CLAP audio encoder branch (audio spectrogram transformer + projection).
 * Reference: transformers/models/clap/modeling_clap.py
 */
public final class CLAPAudioModel {
    private CLAPAudioModel() {}
