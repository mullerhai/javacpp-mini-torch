...
/**
 * ImageGPT for unconditional image generation (pixel-by-pixel autoregressive).
 */
@Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class ImageGPTForUnconditionalImageGeneration extends Module {
    ...
    public ImageGPTForUnconditionalImageGeneration(PretrainedConfig config) {
        super("ImageGPTForUnconditionalImageGeneration");
    ...
    public static ImageGPTForUnconditionalImageGeneration fromConfig(PretrainedConfig config) {
        return new ImageGPTForUnconditionalImageGeneration(config);
    }
    ...
    public Tensor forward(Tensor pixelValues) {
        throw new UnsupportedOperationException("ImageGPT unconditional generation forward not yet implemented");
    }
