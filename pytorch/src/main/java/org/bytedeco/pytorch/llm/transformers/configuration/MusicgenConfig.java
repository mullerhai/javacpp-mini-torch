...
/**
 * HuggingFace <code>musicgenConfig</code>.
 * Reference: transformers/models/musicgen/configuration_musicgen.py
 */
public final class MusicgenConfig extends Config {

    public static final String MODEL_TYPE = "musicgen";
    ...
    public MusicgenConfig(PretrainedConfig base) {
        super(base);
    ...
    @Override public Class<? extends Config> getClass_() { return MusicgenConfig.class; }
