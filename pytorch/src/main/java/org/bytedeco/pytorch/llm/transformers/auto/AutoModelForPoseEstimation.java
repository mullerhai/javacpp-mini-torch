...
import org.bytedeco.pytorch.llm.transformers.modeling.VitPoseForPoseEstimation;
...
/**
 * HF {@code AutoModelForPoseEstimation.from_pretrained} entry point.
 * Routes to VitPose.
 */
public final class AutoModelForPoseEstimation {

    private AutoModelForPoseEstimation() {}
    ...
    public static Bundle fromDirectory(Path dir) throws IOException {
        ...
        String mt = cfg.modelType() == null ? "vitpose" : cfg.modelType().name().toLowerCase();
        ...
        Module model = VitPoseForPoseEstimation.fromConfig(cfg);
