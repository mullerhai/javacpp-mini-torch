...
/**
 * LLaVA-Next (aka LLaVA-1.6) model for conditional generation with high-res image support.
 * Reference: transformers/models/llava_next/modeling_llava_next.py
 */
public final class LlavaNextForConditionalGeneration {
    private LlavaNextForConditionalGeneration() {}
