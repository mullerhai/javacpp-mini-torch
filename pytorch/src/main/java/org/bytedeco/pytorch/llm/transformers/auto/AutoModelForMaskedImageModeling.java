...
import org.bytedeco.pytorch.llm.transformers.modeling.VitMAEForMaskedImageModeling;
...
/**
 * HF {@code AutoModelForMaskedImageModeling.from_pretrained} entry point.
 * Routes to ViTMAE, Beit.
 */
public final class AutoModelForMaskedImageModeling {

    private AutoModelForMaskedImageModeling() {}
    ...
    public static Bundle fromDirectory(Path dir) throws IOException {
        ...
        Module model = VitMAEForMaskedImageModeling.fromConfig(cfg);
