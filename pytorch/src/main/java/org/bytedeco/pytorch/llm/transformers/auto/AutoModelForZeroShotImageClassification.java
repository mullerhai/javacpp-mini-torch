...
import org.bytedeco.pytorch.llm.transformers.modeling.ClipForZeroShotImageClassification;
...
/**
 * HF {@code AutoModelForZeroShotImageClassification.from_pretrained} entry point.
 * Routes to CLIP, Siglip.
 */
public final class AutoModelForZeroShotImageClassification {

    private AutoModelForZeroShotImageClassification() {}
    ...
    public static Bundle fromDirectory(Path dir) throws IOException {
        ...
        String mt = cfg.modelType() == null ? "clip" : cfg.modelType().name().toLowerCase();
        ...
        Module model = ClipForZeroShotImageClassification.fromConfig(cfg);
