...
import org.bytedeco.pytorch.llm.transformers.modeling.AstForAudioClassification;
...
/**
 * HF {@code AutoModelForAudioClassification.from_pretrained} entry point.
 * Routes to AST, Wav2Vec2, Hubert.
 */
public final class AutoModelForAudioClassification {

    private AutoModelForAudioClassification() {}
    ...
    public static Bundle fromDirectory(Path dir) throws IOException {
        ...
        String mt = cfg.modelType() == null ? "ast" : cfg.modelType().name().toLowerCase();
        Module model = AstForAudioClassification.fromConfig(cfg);
