...
import org.bytedeco.pytorch.llm.transformers.modeling.SegformerForSemanticSegmentation;
...
/**
 * HF {@code AutoModelForSemanticSegmentation.from_pretrained} entry point.
 * Routes to Segformer, DPT, UperNet, Dinov2.
 */
public final class AutoModelForSemanticSegmentation {

    private AutoModelForSemanticSegmentation() {}
    ...
    public static Bundle fromDirectory(Path dir) throws IOException {
        ...
        String mt = cfg.modelType() == null ? "segformer" : cfg.modelType().name().toLowerCase();
        ...
        Module model = SegformerForSemanticSegmentation.fromConfig(cfg);
