...
import org.bytedeco.pytorch.llm.transformers.modeling.TapasForTableQuestionAnswering;
...
/**
 * HF {@code AutoModelForTableQuestionAnswering.from_pretrained} entry point.
 * Routes to Tapas.
 */
public final class AutoModelForTableQuestionAnswering {

    private AutoModelForTableQuestionAnswering() {}
    ...
    public static Bundle fromDirectory(Path dir) throws IOException {
        ...
        String mt = cfg.modelType() == null ? "tapas" : cfg.modelType().name().toLowerCase();
        ...
        Module model = TapasForTableQuestionAnswering.fromConfig(cfg);
