...
/**
 * LayoutLMv2 model for document sequence classification (with visual backbone).
 * Reference: transformers/models/layoutlmv2/modeling_layoutlmv2.py
 */
public final class LayoutLMv2ForSequenceClassification {
    private LayoutLMv2ForSequenceClassification() {}
