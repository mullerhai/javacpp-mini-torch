...
/**
 * ALBERT model with a token classification head.
 */
@Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class AlbertForTokenClassification extends Module {
    ...
    public AlbertForTokenClassification(PretrainedConfig config) {
        super("AlbertForTokenClassification");
    ...
    public static AlbertForTokenClassification fromConfig(PretrainedConfig config) {
        return new AlbertForTokenClassification(config);
    }
    ...
    public Tensor forward(Tensor inputIds) {
        throw new UnsupportedOperationException("ALBERT token classification forward not yet implemented");
    }
