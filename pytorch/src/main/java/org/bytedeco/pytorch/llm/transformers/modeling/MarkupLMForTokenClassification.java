...
/**
 * MarkupLM model for token-level classification on HTML/XML documents.
 * Reference: transformers/models/markuplm/modeling_markuplm.py
 */
public final class MarkupLMForTokenClassification {
    private MarkupLMForTokenClassification() {}
