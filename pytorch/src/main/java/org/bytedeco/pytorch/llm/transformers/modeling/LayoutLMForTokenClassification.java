...
/**
 * LayoutLM model for token-level classification (e.g. NER on documents).
 * Reference: transformers/models/layoutlm/modeling_layoutlm.py
 */
public final class LayoutLMForTokenClassification {
    private LayoutLMForTokenClassification() {}
