...
/**
 * HuggingFace <code>stablelmConfig</code>.
 * Reference: transformers/models/stablelm/configuration_stablelm.py
 */
public final class StableLmConfig extends Config {

    public static final String MODEL_TYPE = "stablelm";

    private final boolean useQkvBias;
    private final boolean qkLayernorm;
    private final boolean useParallelResidual;
    private final double hiddenDropout;
    private final double attentionDropout;

    public StableLmConfig(PretrainedConfig base) {
        super(base);
        this.useQkvBias = base.extra().get("use_qkv_bias") == Boolean.TRUE;
        this.qkLayernorm = base.extra().get("qk_layernorm") == Boolean.TRUE;
    ...
    public boolean useQkvBias() { return base().extra().get("use_qkv_bias") == Boolean.TRUE; }
    public boolean qkLayernorm() { return base().extra().get("qk_layernorm") == Boolean.TRUE; }
    ...
    @Override public Class<? extends Config> getClass_() { return StableLmConfig.class; }
