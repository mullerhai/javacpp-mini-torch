...
/**
 * LLaVA model for conditional generation (vision encoder + MLP projector + LLM).
 * Reference: transformers/models/llava/modeling_llava.py
 */
public final class LlavaForConditionalGeneration {
    private LlavaForConditionalGeneration() {}
