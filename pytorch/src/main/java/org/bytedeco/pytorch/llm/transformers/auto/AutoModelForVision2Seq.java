...
import org.bytedeco.pytorch.llm.transformers.modeling.Pix2StructForVision2Seq;
...
/**
 * HF {@code AutoModelForVision2Seq.from_pretrained} entry point.
 * Routes to Pix2Struct, Donut, Nougat, TrOCR.
 */
public final class AutoModelForVision2Seq {

    private AutoModelForVision2Seq() {}
    ...
    public static Bundle fromDirectory(Path dir) throws IOException {
        ...
        String mt = cfg.modelType() == null ? "pix2struct" : cfg.modelType().name().toLowerCase();
        ...
        Module model = Pix2StructForVision2Seq.fromConfig(cfg);
