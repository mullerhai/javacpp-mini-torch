...
/**
 * Minimal stub for ClipSeg-based image segmentation.
 */
public final class ClipSegForImageSegmentation {

    private ClipSegForImageSegmentation() {}

    public static Module fromConfig(PretrainedConfig cfg) {
        return new Module("ClipSegForImageSegmentation") {
            @Override
