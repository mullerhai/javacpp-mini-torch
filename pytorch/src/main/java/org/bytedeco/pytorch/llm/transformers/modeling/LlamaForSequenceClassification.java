 ...
 * Delegates to {@link LlamaForCausalLM} backbone with a classification head on top.
 */
@Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class LlamaForSequenceClassification extends Module {
    ...
    public LlamaForSequenceClassification(PretrainedConfig config) {
        super("LlamaForSequenceClassification");
    ...
    public static LlamaForSequenceClassification fromConfig(PretrainedConfig config) {
        return new LlamaForSequenceClassification(config);
    }
    ...
    public Tensor forward(Tensor inputIds) {
        throw new UnsupportedOperationException("Llama sequence classification forward not yet implemented");
    }
