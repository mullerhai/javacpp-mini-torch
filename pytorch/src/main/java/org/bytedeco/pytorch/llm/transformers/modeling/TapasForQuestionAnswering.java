...
/**
 * TAPAS model for question answering over tables.
 * Reference: transformers/models/tapas/modeling_tapas.py
 */
public final class TapasForQuestionAnswering {
    private TapasForQuestionAnswering() {}
