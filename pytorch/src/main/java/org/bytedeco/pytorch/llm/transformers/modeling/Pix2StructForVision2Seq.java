...
/**
 * Minimal stub for Pix2Struct-based vision-to-sequence.
 */
public final class Pix2StructForVision2Seq {

    private Pix2StructForVision2Seq() {}

    public static Module fromConfig(PretrainedConfig cfg) {
        return new Module("Pix2StructForVision2Seq") {
            @Override
