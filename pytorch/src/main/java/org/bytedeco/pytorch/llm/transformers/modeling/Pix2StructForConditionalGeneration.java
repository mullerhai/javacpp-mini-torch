...
/**
 * Pix2Struct model for conditional generation from images (e.g. visual question answering).
 * Reference: transformers/models/pix2struct/modeling_pix2struct.py
 */
public final class Pix2StructForConditionalGeneration {
    private Pix2StructForConditionalGeneration() {}
