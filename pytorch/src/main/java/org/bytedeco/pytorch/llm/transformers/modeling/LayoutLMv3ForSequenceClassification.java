...
/**
 * LayoutLMv3 model for document sequence classification.
 * Reference: transformers/models/layoutlmv3/modeling_layoutlmv3.py
 */
public final class LayoutLMv3ForSequenceClassification {
    private LayoutLMv3ForSequenceClassification() {}
