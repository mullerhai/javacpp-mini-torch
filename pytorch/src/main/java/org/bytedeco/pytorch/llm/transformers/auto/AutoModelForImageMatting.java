...
import org.bytedeco.pytorch.llm.transformers.modeling.VitMatteForImageMatting;
...
/**
 * HF {@code AutoModelForImageMatting.from_pretrained} entry point.
 * Routes to VitMatte.
 */
public final class AutoModelForImageMatting {

    private AutoModelForImageMatting() {}
    ...
    public static Bundle fromDirectory(Path dir) throws IOException {
        ...
        String mt = cfg.modelType() == null ? "vitmatte" : cfg.modelType().name().toLowerCase();
        ...
        Module model = VitMatteForImageMatting.fromConfig(cfg);
