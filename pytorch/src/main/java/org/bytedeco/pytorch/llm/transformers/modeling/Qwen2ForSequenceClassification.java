...
public class Qwen2ForSequenceClassification extends Module {
    ...
    public Qwen2ForSequenceClassification(PretrainedConfig config) {
        super("Qwen2ForSequenceClassification");
    ...
    public static Qwen2ForSequenceClassification fromConfig(PretrainedConfig config) {
        return new Qwen2ForSequenceClassification(config);
    }
    ...
    public Tensor forward(Tensor inputIds) {
        throw new UnsupportedOperationException("Qwen2 sequence classification forward not yet implemented");
    }
