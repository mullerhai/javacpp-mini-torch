...
/**
 * BERT model with a token classification head (e.g., NER / POS tagging).
 */
@Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class BertForTokenClassification extends Module {
    ...
    public BertForTokenClassification(PretrainedConfig config) {
    ...
    public static BertForTokenClassification fromConfig(PretrainedConfig config) {
    ...
    public Tensor forward(Tensor inputIds) {
        throw new UnsupportedOperationException("BERT token classification forward not yet implemented");
    }
