...
/**
 * LayoutXLM model for multilingual document token classification (XLM-RoBERTa + layout).
 * Reference: transformers/models/layoutxlm/modeling_layoutxlm.py
 */
public final class LayoutXLMForTokenClassification {
    private LayoutXLMForTokenClassification() {}
