...
/**
 * X-CLIP vision encoder branch (video transformer + vision projection).
 * Reference: transformers/models/xclip/modeling_xclip.py
 */
public final class XCLIPVisionModel {
    private XCLIPVisionModel() {}
