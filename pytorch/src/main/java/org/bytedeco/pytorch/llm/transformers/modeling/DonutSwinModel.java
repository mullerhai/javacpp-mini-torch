...
/**
 * Donut Swin Encoder model (Swin transformer backbone used in Donut/DocOwl).
 * Reference: transformers/models/donut/modeling_donut.py
 */
public final class DonutSwinModel {
    private DonutSwinModel() {}
