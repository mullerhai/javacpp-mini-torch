...
/**
 * Generic encoder-decoder model for seq2seq tasks (e.g. image captioning, translation).
 * Reference: transformers/models/encoder_decoder/modeling_encoder_decoder.py
 */
public final class EncoderDecoderModel {
    private EncoderDecoderModel() {}
