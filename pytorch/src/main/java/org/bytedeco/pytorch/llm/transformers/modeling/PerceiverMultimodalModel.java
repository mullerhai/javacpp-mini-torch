...
/**
 * Perceiver multimodal model (joint encoder for vision, audio, text).
 * Reference: transformers/models/perceiver/modeling_perceiver.py
 */
public final class PerceiverMultimodalModel {
    private PerceiverMultimodalModel() {}
