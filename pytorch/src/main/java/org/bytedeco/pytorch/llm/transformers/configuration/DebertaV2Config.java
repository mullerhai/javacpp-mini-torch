...
/**
 * HuggingFace <code>deberta_v2Config</code>.
 * Reference: transformers/models/deberta_v2/configuration_deberta_v2.py
 */
public final class DebertaV2Config extends Config {

    public static final String MODEL_TYPE = "deberta_v2";
    ...
    public DebertaV2Config(PretrainedConfig base) {
        super(base);
    ...
    @Override public Class<? extends Config> getClass_() { return DebertaV2Config.class; }
