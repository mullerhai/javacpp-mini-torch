...
/**
 * VisionEncoderDecoder model: generic encoder-decoder for vision tasks.
 * Reference: transformers/models/vision_encoder_decoder/modeling_vision_encoder_decoder.py
 */
public final class VisionEncoderDecoderModel {
    private VisionEncoderDecoderModel() {}
