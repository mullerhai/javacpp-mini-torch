...
/**
 * Java analog of HuggingFace {@code peft.tuners.ia3.Conv3d}.
 */
public class IA3Conv3d extends IA3Layer {

    private final Conv3dImpl baseLayer;
    private final long outChannels;

    public IA3Conv3d(Conv3dImpl baseLayer, String name) {
        super();
    ...
    public void updateLayer(String adapterName, boolean initWeights, IA3ConfigBackref config) {
        ...
        Tensor l = ones(new long[]{size, 1, 1, 1}).contiguous().clone();
