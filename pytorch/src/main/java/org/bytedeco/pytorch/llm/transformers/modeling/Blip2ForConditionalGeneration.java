...
/**
 * BLIP-2 model for conditional generation (vision-language-to-text).
 * Reference: transformers/models/blip_2/modeling_blip_2.py
 */
public final class Blip2ForConditionalGeneration {
    private Blip2ForConditionalGeneration() {}
