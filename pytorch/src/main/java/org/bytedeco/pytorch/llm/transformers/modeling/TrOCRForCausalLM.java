...
/**
 * TrOCR (Vision Transformer OCR) model for handwritten/printed text recognition.
 * Reference: transformers/models/trocr/modeling_trocr.py
 */
public final class TrOCRForCausalLM {
    private TrOCRForCausalLM() {}
