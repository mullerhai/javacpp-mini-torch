...
/**
 * DeBERTa-v2 (v2 / xlarge / xxlarge) model with a sequence classification head.
 */
@Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class DebertaV2ForSequenceClassification extends Module {
    ...
    public DebertaV2ForSequenceClassification(PretrainedConfig config) {
        super("DebertaV2ForSequenceClassification");
    ...
    public static DebertaV2ForSequenceClassification fromConfig(PretrainedConfig config) {
    ...
    public Tensor forward(Tensor inputIds) {
        throw new UnsupportedOperationException("DeBERTa-v2 sequence classification forward not yet implemented");
    }
