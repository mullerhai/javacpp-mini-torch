...
import org.bytedeco.pytorch.llm.transformers.modeling.GroundingDinoForZeroShotObjectDetection;
...
/**
 * HF {@code AutoModelForZeroShotObjectDetection.from_pretrained} entry point.
 * Routes to GroundingDINO, Owlv2.
 */
public final class AutoModelForZeroShotObjectDetection {

    private AutoModelForZeroShotObjectDetection() {}
    ...
    public static Bundle fromDirectory(Path dir) throws IOException {
        ...
        String mt = cfg.modelType() == null ? "grounding-dino" : cfg.modelType().name().toLowerCase();
        ...
        Module model = GroundingDinoForZeroShotObjectDetection.fromConfig(cfg);
