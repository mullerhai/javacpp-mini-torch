...
/**
 * LUKE model with a masked language modeling head.
 */
@Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class LukeForMaskedLM extends Module {
    ...
    public LukeForMaskedLM(PretrainedConfig config) {
        super("LukeForMaskedLM");
    ...
    public static LukeForMaskedLM fromConfig(PretrainedConfig config) {
        return new LukeForMaskedLM(config);
    }
    ...
    public Tensor forward(Tensor inputIds) {
        throw new UnsupportedOperationException("LUKE masked LM forward not yet implemented");
    }
