...
/**
 * Output for semantic segmentation models.
 * Mimics HuggingFace: transformers.modeling_outputs.SemanticSegmenterOutput
 */
public class SemanticSegmenterOutput extends org.bytedeco.pytorch.llm.transformers.modeling.output.ModelOutput {
    ...
    public SemanticSegmenterOutput(org.bytedeco.pytorch.Tensor logits) {
        this(null, logits, null);
    }

    public SemanticSegmenterOutput(org.bytedeco.pytorch.Tensor loss,
