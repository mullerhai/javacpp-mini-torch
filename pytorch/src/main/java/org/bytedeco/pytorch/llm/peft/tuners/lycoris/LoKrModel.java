...
public class LoKrModel extends BaseTuner {
    public LoKrModel(Module model, Map<String, PeftConfig> configs, String adapterName) {
        super(model, configs, adapterName, "lokr_");
    }
    @Override
    protected BaseTunerLayer _createNewLayer(PeftConfig cfg, String adapterName,
                                              String targetName, Module target) { return null; }
    @Override public PeftType peftType() { return PeftType.LOKR; }
}
