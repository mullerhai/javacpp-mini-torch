...
/**
 * Hubert model with CTC head (self-supervised speech representation).
 * Reference: transformers/models/hubert/modeling_hubert.py
 */
public final class HubertForCTC {
    private HubertForCTC() {}
