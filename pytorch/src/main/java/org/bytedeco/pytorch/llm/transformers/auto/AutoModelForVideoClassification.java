...
import org.bytedeco.pytorch.llm.transformers.modeling.VideoMaeForVideoClassification;
...
/**
 * HF {@code AutoModelForVideoClassification.from_pretrained} entry point.
 * Routes to VideoMAE, XCLIP.
 */
public final class AutoModelForVideoClassification {

    private AutoModelForVideoClassification() {}

    public static final class Bundle {
        public final Module model;
        public final FastTokenizer tokenizer;
        public final VideoProcessor videoProcessor;
        public final PretrainedConfig config;
        public final Path snapshot;
        public final WeightLoader.LoadReport loadReport;
        public final String modelType;

        public Bundle(Module model, FastTokenizer tokenizer, VideoProcessor videoProcessor,
    ...
    public static Bundle fromDirectory(Path dir) throws IOException {
        ...
        String mt = cfg.modelType() == null ? "videomae" : cfg.modelType().name().toLowerCase();
        ...
        VideoProcessor vp = VideoProcessor.createDefault();
        Module model = VideoMaeForVideoClassification.fromConfig(cfg);
        WeightLoader.LoadReport rep = WeightLoader.loadAndBind(model, dir);
        return new Bundle(model, tok, vp, cfg, dir, rep, mt);
    }
}
