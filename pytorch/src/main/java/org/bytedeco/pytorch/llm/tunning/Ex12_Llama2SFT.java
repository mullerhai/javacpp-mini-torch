...
/** Ex12 — Llama-2-7B SFT with PEFT + SFTTrainer + QLoRA. */
public final class Ex12_Llama2SFT {
    public static final String NAME = "Ex12_Llama2SFT";

    public static void run(FastTokenizer tokenizer) throws IOException {
        TunningSupport.banner(12, "Llama-2 SFT");
        File out = new File("build/ex12_outputs"); out.mkdirs();
        FastTokenizer tok = AutoTokenizer.fromPretrainedTokenizerOnly("NousResearch/Llama-2-7b-hf");
    ...
    public static void main(String[] args) throws IOException { run(TunningSupport.tokenizerFor("NousResearch/Llama-2-7b-hf")); }
}
