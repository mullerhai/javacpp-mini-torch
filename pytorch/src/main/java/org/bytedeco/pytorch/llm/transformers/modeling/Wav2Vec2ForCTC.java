...
/**
 * Wav2Vec2 model with CTC (Connectionist Temporal Classification) head.
 * Reference: transformers/models/wav2vec2/modeling_wav2vec2.py
 */
public final class Wav2Vec2ForCTC {
    private Wav2Vec2ForCTC() {}
