...
/**
 * LUKE model for entity-pair classification.
 * LUKE treats entity mentions as special tokens and is pretrained with entity-level MLM.
 */
@Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class LukeForEntityPairClassification extends Module {
    ...
    public LukeForEntityPairClassification(PretrainedConfig config) {
        super("LukeForEntityPairClassification");
    ...
    public static LukeForEntityPairClassification fromConfig(PretrainedConfig config) {
        return new LukeForEntityPairClassification(config);
    }
    ...
    public Tensor forward(Tensor inputIds) {
        throw new UnsupportedOperationException("LUKE entity pair classification forward not yet implemented");
    }
