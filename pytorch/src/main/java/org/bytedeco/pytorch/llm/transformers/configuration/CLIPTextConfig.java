...
/**
 * HuggingFace <code>clip_text_modelConfig</code>.
 */
public final class CLIPTextConfig extends Config {

    public static final String MODEL_TYPE = "clip_text_model";
    ...
    public CLIPTextConfig(PretrainedConfig base) {
        super(base);
    ...
    @Override public Class<? extends Config> getClass_() { return CLIPTextConfig.class; }
