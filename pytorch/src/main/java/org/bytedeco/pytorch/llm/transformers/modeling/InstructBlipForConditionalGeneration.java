...
/**
 * InstructBLIP model for conditional generation with instruction-aware visual features.
 * Reference: transformers/models/instructblip/modeling_instructblip.py
 */
public final class InstructBlipForConditionalGeneration {
    private InstructBlipForConditionalGeneration() {}
