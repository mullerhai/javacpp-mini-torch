...
/**
 * HuggingFace <code>phiConfig</code>.
 * Reference: transformers/models/phi/configuration_phi.py
 */
public final class PhiConfig extends Config {

    public static final String MODEL_TYPE = "phi";

    private final boolean qkLayernorm;
    private final double residPdrop;
    private final double embdPdrop;

    public PhiConfig(PretrainedConfig base) {
        super(base);
    ...
    @Override public Class<? extends Config> getClass_() { return PhiConfig.class; }
