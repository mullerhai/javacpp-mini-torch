...
/** SFT stage bridge → {@link SFTTrainer}. */
public final class SftTrainerBridge {
    private SftTrainerBridge() {}
    ...
    public static SFTTrainer create(FactoryArgs args, LoadedModel loaded, int maxSteps) {
        ...
        throw new IllegalStateException("TrainerFactory did not return SFTTrainer for SFT stage");
    }
}
