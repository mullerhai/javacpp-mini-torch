...
/**
 * UDOP (Universal Document Processing) model for conditional generation from documents.
 * Reference: transformers/models/udop/modeling_udop.py
 */
public final class UdopForConditionalGeneration {
    private UdopForConditionalGeneration() {}
