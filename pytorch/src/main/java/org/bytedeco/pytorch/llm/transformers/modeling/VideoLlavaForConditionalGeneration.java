...
/**
 * Video-LLaVA model for video conditional generation.
 * Reference: transformers/models/video_llava/modeling_video_llava.py
 */
public final class VideoLlavaForConditionalGeneration {
    private VideoLlavaForConditionalGeneration() {}
