...
/**
 * Whisper model for conditional generation (multilingual speech recognition/translation).
 * Reference: transformers/models/whisper/modeling_whisper.py
 */
public final class WhisperForConditionalGeneration {
    private WhisperForConditionalGeneration() {}
