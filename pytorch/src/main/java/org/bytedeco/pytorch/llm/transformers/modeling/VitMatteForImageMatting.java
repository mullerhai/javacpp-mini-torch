...
/**
 * Minimal stub for VitMatte-based image matting.
 */
public final class VitMatteForImageMatting {

    private VitMatteForImageMatting() {}

    public static Module fromConfig(PretrainedConfig cfg) {
        return new Module("VitMatteForImageMatting") {
            @Override
