...
/**
 * HuggingFace <code>smollmConfig</code>.
 */
public final class SmolLmConfig extends Config {

    public static final String MODEL_TYPE = "smollm";

    private final double attentionDropout;

    public SmolLmConfig(PretrainedConfig base) {
        super(base);
    ...
    @Override public Class<? extends Config> getClass_() { return SmolLmConfig.class; }
