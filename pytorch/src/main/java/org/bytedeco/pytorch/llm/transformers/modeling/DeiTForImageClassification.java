...
/**
 * Data-efficient image Transformer (DeiT) for image classification.
 */
@Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class DeiTForImageClassification extends Module {
    ...
    public DeiTForImageClassification(PretrainedConfig config) {
        super("DeiTForImageClassification");
    ...
    public static DeiTForImageClassification fromConfig(PretrainedConfig config) {
        return new DeiTForImageClassification(config);
    }
    ...
    public Tensor forward(Tensor pixelValues) {
        throw new UnsupportedOperationException("DeiT image classification forward not yet implemented");
    }
