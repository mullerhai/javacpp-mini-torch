...
import org.bytedeco.pytorch.llm.transformers.modeling.Swin2SRForImageSuperResolution;
...
/**
 * HF {@code AutoModelForImageSuperResolution.from_pretrained} entry point.
 * Routes to Swin2SR.
 */
public final class AutoModelForImageSuperResolution {

    private AutoModelForImageSuperResolution() {}
    ...
    public static Bundle fromDirectory(Path dir) throws IOException {
        ...
        String mt = cfg.modelType() == null ? "swin2sr" : cfg.modelType().name().toLowerCase();
        ...
        Module model = Swin2SRForImageSuperResolution.fromConfig(cfg);
