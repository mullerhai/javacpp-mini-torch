...
/**
 * Autoformer model for long-sequence time-series forecasting with decomposition.
 * Reference: transformers/models/autoformer/modeling_autoformer.py
 */
public final class AutoformerForPrediction {
    private AutoformerForPrediction() {}
