...
/**
 * PaliGemma model for conditional generation (SigLIP vision + Gemma LLM).
 * Reference: transformers/models/paligemma/modeling_paligemma.py
 */
public final class PaliGemmaForConditionalGeneration {
    private PaliGemmaForConditionalGeneration() {}
