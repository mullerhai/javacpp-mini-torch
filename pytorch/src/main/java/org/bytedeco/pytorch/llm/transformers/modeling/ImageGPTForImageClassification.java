...
/**
 * ImageGPT for image classification (linear head on final hidden state).
 */
@Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class ImageGPTForImageClassification extends Module {

    static { Loader.load(org.bytedeco.pytorch.presets.torch.class); }

    private final PretrainedConfig config;
    private final Module igpt;
    private final LinearImpl classifier;

    public ImageGPTForImageClassification(PretrainedConfig config) {
        super("ImageGPTForImageClassification");
    ...
    public static ImageGPTForImageClassification fromConfig(PretrainedConfig config) {
        return new ImageGPTForImageClassification(config);
    }
    ...
    public Tensor forward(Tensor pixelValues) {
        throw new UnsupportedOperationException("ImageGPT image classification forward not yet implemented");
    }
