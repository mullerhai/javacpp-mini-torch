...
/**
 * AST (Audio Spectrogram Transformer) model for audio classification.
 * Reference: transformers/models/audio-spectrogram-transformer/modeling_audio_spectrogram_transformer.py
 */
public final class ASTForAudioClassification {
    private ASTForAudioClassification() {}
