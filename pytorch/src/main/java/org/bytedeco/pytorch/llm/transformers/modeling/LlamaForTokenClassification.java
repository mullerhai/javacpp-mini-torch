...
/**
 * Llama model with a token classification head (NER / POS tagging).
 */
@Properties(inherit = org.bytedeco.pytorch.presets.torch.class)
public class LlamaForTokenClassification extends Module {
    ...
    public LlamaForTokenClassification(PretrainedConfig config) {
        super("LlamaForTokenClassification");
    ...
    public static LlamaForTokenClassification fromConfig(PretrainedConfig config) {
        return new LlamaForTokenClassification(config);
    }
    ...
    public Tensor forward(Tensor inputIds) {
        throw new UnsupportedOperationException("Llama token classification forward not yet implemented");
    }
