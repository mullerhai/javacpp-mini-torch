...
/**
 * Minimal stub for BERT-based question answering.
 */
public final class BertForQuestionAnswering {

    private BertForQuestionAnswering() {}

    public static Module fromConfig(PretrainedConfig cfg) {
        return new Module("BertForQuestionAnswering") {
            @Override
