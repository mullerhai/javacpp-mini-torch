...
/**
 * Minimal stub for DPT-based depth estimation.
 */
public final class DptForDepthEstimation {

    private DptForDepthEstimation() {}

    public static Module fromConfig(PretrainedConfig cfg) {
        return new Module("DptForDepthEstimation") {
            @Override
