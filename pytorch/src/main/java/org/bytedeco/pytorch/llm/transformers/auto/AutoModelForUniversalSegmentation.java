...
import org.bytedeco.pytorch.llm.transformers.modeling.Mask2FormerForUniversalSegmentation;
...
/**
 * HF {@code AutoModelForUniversalSegmentation.from_pretrained} entry point.
 * Routes to Mask2Former, OneFormer, EoMT.
 */
public final class AutoModelForUniversalSegmentation {

    private AutoModelForUniversalSegmentation() {}
    ...
    public static Bundle fromDirectory(Path dir) throws IOException {
        ...
        String mt = cfg.modelType() == null ? "mask2former" : cfg.modelType().name().toLowerCase();
        ...
        Module model = Mask2FormerForUniversalSegmentation.fromConfig(cfg);
