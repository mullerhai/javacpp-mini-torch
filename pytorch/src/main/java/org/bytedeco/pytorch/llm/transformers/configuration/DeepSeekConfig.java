...
/**
 * HuggingFace <code>deepseekConfig</code>.
 * Reference: transformers/models/deepseek/configuration_deepseek.py
 */
public final class DeepSeekConfig extends Config {

    public static final String MODEL_TYPE = "deepseek";

    private final int pretrainingTp;
    private final boolean attentionBias;
    private final boolean mlpBias;

    public DeepSeekConfig(PretrainedConfig base) {
        super(base);
    ...
    @Override public Class<? extends Config> getClass_() { return DeepSeekConfig.class; }
