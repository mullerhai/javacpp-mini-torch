...
/**
 * HuggingFace <code>olmo2Config</code>.
 * Reference: transformers/models/olmo2/configuration_olmo2.py
 */
public final class Olmo2Config extends Config {

    public static final String MODEL_TYPE = "olmo2";

    private final double rmsNormEps;
    private final boolean attentionBias;
    private final String ropeParameters;

    public Olmo2Config(PretrainedConfig base) {
        super(base);
    ...
    @Override public Class<? extends Config> getClass_() { return Olmo2Config.class; }
