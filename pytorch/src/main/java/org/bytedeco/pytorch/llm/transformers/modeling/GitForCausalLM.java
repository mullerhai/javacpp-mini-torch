...
/**
 * GIT (Generative Image-to-Text) model for conditional generation.
 * Reference: transformers/models/git/modeling_git.py
 */
public final class GitForCausalLM {
    private GitForCausalLM() {}
