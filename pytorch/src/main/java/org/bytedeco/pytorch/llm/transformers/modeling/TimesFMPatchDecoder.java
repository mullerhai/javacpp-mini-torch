...
/**
 * TimesFM patch decoder (decodes embedded time-series patches back to values).
 * Reference: transformers/models/times_fm/modeling_times_fm.py
 */
public final class TimesFMPatchDecoder {
    private TimesFMPatchDecoder() {}
