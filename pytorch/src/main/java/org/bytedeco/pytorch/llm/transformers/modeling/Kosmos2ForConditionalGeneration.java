...
/**
 * Kosmos-2 model for grounded conditional generation (image + text to text with entity spans).
 * Reference: transformers/models/kosmos2/modeling_kosmos2.py
 */
public final class Kosmos2ForConditionalGeneration {
    private Kosmos2ForConditionalGeneration() {}
