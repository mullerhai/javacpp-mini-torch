...
public class LoHaModel extends BaseTuner {
    public LoHaModel(Module model, Map<String, PeftConfig> configs, String adapterName) {
        super(model, configs, adapterName, "hada_");
    }
    @Override
    protected BaseTunerLayer _createNewLayer(PeftConfig cfg, String adapterName,
                                              String targetName, Module target) { return null; }
    @Override public PeftType peftType() { return PeftType.LOHA; }
}
