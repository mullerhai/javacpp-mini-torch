...
/**
 * HuggingFace <code>robertaConfig</code>.
 * Reference: transformers/models/roberta/configuration_roberta.py
 */
public final class RobertaConfig extends Config {

    public static final String MODEL_TYPE = "roberta";
    ...
    public RobertaConfig(PretrainedConfig base) {
        super(base);
    ...
    @Override public Class<? extends Config> getClass_() { return RobertaConfig.class; }
