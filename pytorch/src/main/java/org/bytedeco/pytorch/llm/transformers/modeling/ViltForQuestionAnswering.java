...
/**
 * ViLT model for image-and-text multimodal understanding.
 * Reference: transformers/models/vilt/modeling_vilt.py
 */
public final class ViltForQuestionAnswering {
    private ViltForQuestionAnswering() {}
