...
import org.bytedeco.pytorch.llm.transformers.modeling.LayoutLMForDocumentQuestionAnswering;
...
/**
 * HF {@code AutoModelForDocumentQuestionAnswering.from_pretrained} entry point.
 * Routes to LayoutLMv2, LayoutLMv3, Pix2Struct, Donut.
 */
public final class AutoModelForDocumentQuestionAnswering {

    private AutoModelForDocumentQuestionAnswering() {}
    ...
    public static Bundle fromDirectory(Path dir) throws IOException {
        ...
        String mt = cfg.modelType() == null ? "layoutlm" : cfg.modelType().name().toLowerCase();
        ...
        Module model = LayoutLMForDocumentQuestionAnswering.fromConfig(cfg);
