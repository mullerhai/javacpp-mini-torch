...
/**
 * LayoutLMv3 model for token-level classification on documents.
 * Reference: transformers/models/layoutlmv3/modeling_layoutlmv3.py
 */
public final class LayoutLMv3ForTokenClassification {
    private LayoutLMv3ForTokenClassification() {}
