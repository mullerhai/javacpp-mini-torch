...
import org.bytedeco.pytorch.llm.transformers.modeling.BertForQuestionAnswering;
...
/**
 * HF {@code AutoModelForQuestionAnswering.from_pretrained} entry point.
 * Routes to Bert, Electra, Luke, Canine, Albert, Roberta, Deberta.
 */
public final class AutoModelForQuestionAnswering {

    private AutoModelForQuestionAnswering() {}
    ...
    public static Bundle fromDirectory(Path dir) throws IOException {
        ...
        String mt = cfg.modelType() == null ? "bert" : cfg.modelType().name().toLowerCase();
        ...
        Module model = BertForQuestionAnswering.fromConfig(cfg);
