...
/**
 * Output for Visual Question Answering models.
 * Mimics HuggingFace: transformers.modeling_outputs.VisualQuestionAnsweringOutput
 */
public class VisualQuestionAnsweringOutput extends org.bytedeco.pytorch.llm.transformers.modeling.output.ModelOutput {
    ...
    public VisualQuestionAnsweringOutput(org.bytedeco.pytorch.Tensor logits) {
        this(null, logits, null);
    }

    public VisualQuestionAnsweringOutput(org.bytedeco.pytorch.Tensor loss,
