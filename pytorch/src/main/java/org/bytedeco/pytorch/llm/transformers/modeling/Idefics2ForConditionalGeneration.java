...
/**
 * Idefics2 model for conditional generation (HuggingFaceM4/Idefics2).
 * Reference: transformers/models/idefics2/modeling_idefics2.py
 */
public final class Idefics2ForConditionalGeneration {
    private Idefics2ForConditionalGeneration() {}
