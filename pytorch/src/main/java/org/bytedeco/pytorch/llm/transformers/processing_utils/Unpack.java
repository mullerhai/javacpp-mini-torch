...
/**
 * Marker annotation indicating that method arguments should be unpacked
 * into separate kwargs.
 *
 * <p>Reference: HuggingFace transformers
 * {@code processing_utils.Unpack}.
 *
 * <p>Used for documentation and code generation purposes only;
