...
/**
 * LiLT (Layout-aware Language model with a Unified multi-task Transformer) for token classification.
 * Reference: transformers/models/lilt/modeling_lilt.py
 */
public final class LiLTForTokenClassification {
    private LiLTForTokenClassification() {}
