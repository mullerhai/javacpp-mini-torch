...
import org.bytedeco.pytorch.llm.transformers.modeling.ViltForVisualQuestionAnswering;
...
/**
 * HF {@code AutoModelForVisualQuestionAnswering.from_pretrained} entry point.
 * Routes to Vilt, Blip2, InstructBlip, Idefics2, Llava.
 */
public final class AutoModelForVisualQuestionAnswering {

    private AutoModelForVisualQuestionAnswering() {}
    ...
    public static Bundle fromDirectory(Path dir) throws IOException {
        ...
        String mt = cfg.modelType() == null ? "vilt" : cfg.modelType().name().toLowerCase();
        ...
        Module model = ViltForVisualQuestionAnswering.fromConfig(cfg);
