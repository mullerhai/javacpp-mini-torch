...
/**
 * HuggingFace <code>qwen2_vlConfig</code>.
 * Reference: transformers/models/qwen2_vl/configuration_qwen2_vl.py
 */
public final class Qwen2VLConfig extends Config {

    public static final String MODEL_TYPE = "qwen2_vl";
    ...
    public Qwen2VLConfig(PretrainedConfig base) {
        super(base);
        this.depth = toInt(base.extra().get("depth"), 32);
        this.embedDim = toInt(base.extra().get("embed_dim"), 1280);
    ...
    public int embedDim() { return toInt(base().extra().get("embed_dim"), 1280); }
    ...
    @Override public Class<? extends Config> getClass_() { return Qwen2VLConfig.class; }
