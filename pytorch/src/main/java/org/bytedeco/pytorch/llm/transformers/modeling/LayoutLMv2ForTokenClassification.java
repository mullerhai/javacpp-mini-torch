...
/**
 * LayoutLMv2 model for token-level classification (e.g. document NER).
 * Reference: transformers/models/layoutlmv2/modeling_layoutlmv2.py
 */
public final class LayoutLMv2ForTokenClassification {
    private LayoutLMv2ForTokenClassification() {}
