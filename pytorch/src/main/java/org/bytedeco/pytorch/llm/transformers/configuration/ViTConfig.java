...
/**
 * HuggingFace <code>vitConfig</code>.
 * Reference: transformers/models/vit/configuration_vit.py
 */
public final class ViTConfig extends Config {

    public static final String MODEL_TYPE = "vit";
    ...
    public ViTConfig(PretrainedConfig base) {
        super(base);
    ...
    @Override public Class<? extends Config> getClass_() { return ViTConfig.class; }
