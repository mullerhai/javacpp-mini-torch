...
/**
 * Scales logits by 1/temperature (HF {@code TemperatureLogitsWarper}).
 */
public final class TemperatureLogitsWarper extends LogitsProcessor {
    ...
    public Tensor call(Tensor inputIds, Tensor scores) {
        if (temperature == 1.0f) return scores;
        return scores.div(new org.bytedeco.pytorch.Scalar(temperature));
    }
}
