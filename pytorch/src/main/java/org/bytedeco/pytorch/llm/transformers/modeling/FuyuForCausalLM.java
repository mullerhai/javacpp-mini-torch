...
/**
 * Fuyu model for causal language modeling with image inputs.
 * Reference: transformers/models/fuyu/modeling_fuyu.py
 */
public final class FuyuForCausalLM {
    private FuyuForCausalLM() {}
