...
/**
 * HuggingFace <code>phi2Config</code>.
 * Reference: transformers/models/phi2/configuration_phi2.py
 */
public final class Phi2Config extends Config {

    public static final String MODEL_TYPE = "phi2";

    private final boolean qkLayernorm;
    private final double residPdrop;
    private final double embdPdrop;

    public Phi2Config(PretrainedConfig base) {
        super(base);
    ...
    @Override public Class<? extends Config> getClass_() { return Phi2Config.class; }
